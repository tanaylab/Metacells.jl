...
function compute_fraction_per_used_module_per_region_cell(
    ...
    module_index_per_covered_gene = daf["/ gene & is_covered / block = $(block_name) : module ?? 0 => index"].array
    used_module_indices = daf["/ module & is_strong ; block = $(block_name) : index"].array
