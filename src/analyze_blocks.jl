...
import Metacells.Contracts.block_gene_is_neighborhood_marker
...
"""
    compute_blocks_genes_is_neighborhood_markers!(
        daf::DafWriter;
...
@logged @computation Contract(
    ...
    data = [
        ...
        block_gene_is_neighborhood_marker(GuaranteedOutput),
    ],
    ...
    is_neighborhood_marker_per_gene_per_block = Matrix{Bool}(undef, n_genes, n_blocks)
    ...
    for block_index in 1:n_blocks
        ...
        adapter(  # NOJET
            ...
            return is_neighborhood_marker_per_gene_per_block[:, block_index] =
...
@logged @computation Contract(
    ...
    data = [
        ...
        metacell_gene_fraction_matrix(RequiredInput),
        metacell_gene_log_fraction_matrix(RequiredInput),
        block_gene_is_environment_marker(GuaranteedOutput),
    ],
    ...
    for block_index in 1:n_blocks
        ...
        adapter(  # NOJET
            ...
            identify_marker_genes!(adapted; min_marker_gene_max_fraction, min_marker_gene_range_fold)
            return is_environment_marker_per_gene_per_block[:, block_index] =
                get_vector(adapted, "gene", "is_marker").array
        end
    end
    set_matrix!(
