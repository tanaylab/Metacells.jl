...
Metacells.Contracts.vector_of_outlier_in_metacell_per_cell
Metacells.Contracts.vector_of_outlier_by_prev_block_per_cell
Metacells.Contracts.vector_of_outlier_by_prev_module_per_cell
Metacells.Contracts.vector_of_outlier_expected_UMIs_per_cell
Metacells.Contracts.vector_of_outlier_actual_UMIs_per_cell
```
...
```@docs
Metacells.Contracts.matrix_of_is_in_environment_per_metacell_per_block
Metacells.Contracts.vector_of_n_environment_metacells_per_block
Metacells.Contracts.vector_of_n_environment_cells_per_block
Metacells.Contracts.vector_of_total_environment_UMIs_per_block
Metacells.Contracts.matrix_of_is_environment_marker_per_gene_per_block
Metacells.Contracts.matrix_of_is_environment_distinct_per_gene_per_block
Metacells.Contracts.matrix_of_is_correlated_with_skeleton_in_environment_per_gene_per_block
```
...
Metacells.Contracts.vector_of_global_flow_order_per_type
...
Metacells.Contracts.matrix_of_mean_linear_fraction_in_environment_cells_per_module_per_block
Metacells.Contracts.matrix_of_std_linear_fraction_in_environment_cells_per_module_per_block
...
Metacells.Contracts.vector_of_correlation_between_cells_and_projected_punctuated_metacells_per_gene
...
Metacells.Contracts.vector_of_mean_correlation_between_base_neighborhood_cells_and_punctuated_metacells_per_base_block
Metacells.Contracts.vector_of_mean_no_module_fraction_in_base_neighborhood_cells_at_improved_base_blocks_per_gene
Metacells.Contracts.vector_of_mean_no_module_fraction_in_base_neighborhood_cells_at_degraded_base_blocks_per_gene
Metacells.Contracts.matrix_of_mean_shared_module_fraction_in_base_neighborhood_cells_at_improved_base_blocks_per_regulator_per_gene
Metacells.Contracts.matrix_of_mean_shared_module_fraction_in_base_neighborhood_cells_at_degraded_base_blocks_per_regulator_per_gene
Metacells.Contracts.matrix_of_correlation_between_base_neighborhood_cells_and_projected_metacells_per_gene_per_base_block
Metacells.Contracts.matrix_of_correlation_between_base_neighborhood_cells_and_projected_punctuated_metacells_per_gene_per_base_block
Metacells.Contracts.matrix_of_correlation_between_markers_per_gene_per_gene
